			...
			<div class="col-xl-3 col-lg-3 col-md-4 col-sm-12 col-12 mt-4">
				...
				<div class="col-md-12 p-0 pt-4 pb-4 userdashboard">
					...
					<div class="mt-4" id="menu">
						...
						<li class="">
							<a href="{{url('updateinformation')}}"><i class="fa fa-user-circle-o" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;Basic Information</a></li>
							<li class="">
									...
									<tbody>
										...
										<tr>
											<td title="view invoice" >
												<a href="{{url('invoice/'.$OrderData->id)}}" class="text-dark font-weight-bold" target="_blabk">
													{{$OrderData->id}}
												</a>
											</td>
