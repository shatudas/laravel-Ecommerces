	...
	<div class="single_product">
		<div class="container">
			<div class="row">
				...
				<!-- {{url('public/fontlink')}}/Images -->
				<div class="col-lg-2 order-lg-1 order-2">
					<ul class="image_list">
						<li data-image="{{url('public/fontlink')}}/images/single_4.jpg"><img src="{{url('public/fontlink')}}/images/single_4.jpg" alt=""></li>
						<li data-image="{{url('public/fontlink')}}/images/single_2.jpg"><img src="{{url('public/fontlink')}}/images/single_2.jpg" alt=""></li>
						<li data-image="{{url('public/fontlink')}}/images/single_3.jpg"><img src="{{url('public/fontlink')}}/images/single_3.jpg" alt=""></li>
					</ul>
				</div>

				<!-- Selected Image -->
				<div class="col-lg-5 order-lg-2 order-1">
					<div class="image_selected"><img src="{{url('public/fontlink')}}/images/single_4.jpg" alt=""></div>
				</div>
