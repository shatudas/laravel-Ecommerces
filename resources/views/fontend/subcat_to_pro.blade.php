	...
	<div class="container">
		...
		<div>
			<ul class="uk-breadcrumb" style="display: flex; flex-wrap: wrap; padding: 0;list-style: none;">
				<li>
					<a href="http://dubai2bd.com">Home</a></li>
					&nbsp;&nbsp;&nbsp;<i style="margin-top:3px;">|</i>&nbsp;&nbsp;&nbsp;
					<li>
						<a href="http://dubai2bd.com"><span style="color:gray;">{{$catname->item_name}}</span></a></li>
						&nbsp;&nbsp;&nbsp;<i style="margin-top:3px;">|</i>&nbsp;&nbsp;&nbsp;
						<li>
							<a href="http://dubai2bd.com"><span style="color:gray;">{{$catname->category_name}}</span></a></li>
							&nbsp;&nbsp;&nbsp;<i style="margin-top:3px;">|</i>&nbsp;&nbsp;&nbsp;
							<li>
