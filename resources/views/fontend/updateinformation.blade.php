	...
	<div class="container-fluid padd py-4">
       ...
       <strong >{{ Auth()->user()->name }}</strong>
					...
					<div class="mt-4" id="menu">
						...
						<li class=" active ">
							<a href="{{url('updateinformation')}}">
								<i class="fa fa-user-circle-o" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;&nbsp;Basic Information</a>
							</li>
							<li class="">
        ...
        @csrf
				...
				<div class="col-xl-9 col-lg-9 col-md-8 col-sm-12 col-12 mt-4">
					...
					<div class="col-md-10 p-4 userdashboard">
						...
						<form method="post" action="{{url('userDataUpdate/'.Auth()->user()->id)}}" class="row passreset" id="btn-submit" >
							@csrf
