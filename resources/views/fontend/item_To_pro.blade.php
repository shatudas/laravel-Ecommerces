	...
	<div class="container-fluid">
		...
		<div>
			<ul class="uk-breadcrumb" style="display: flex; flex-wrap: wrap;list-style: none;">
				...
				<li><span style="color:gray">{{$itemName->item_name}}</span></li>
			</ul>
		</div>
			...
			<div class="col-lg-2 col-md-12 col-sm-12 col-12 p-0 "  style="border-radius:0px;">
				...
				<div class="list-group bg-dark " style="border-radius:0px;">
					...
					<div class="sidebarcat">
						...
						<a href="{{url('catProduct/'.$catname->id)}}" class="list-group-item list-group-item-action">{{$catname->category_name}}</a>
						@endforeach
					</div>
						...
						<div class="col-lg-3 cl-md-4 col-sm-6 col-6 mt-4">
							...
							<div class="homeproducts border">
								<center>
									...
									<a href="{{url('product_view/'.$prodata->id)}}"><img src="{{url($prodata->product_image)}}" class="img-fluid" style=""></a>
								</center>
								<div>
									<a href="{{url('product_view/'.$prodata->id)}}">
										<center>
										 @php
